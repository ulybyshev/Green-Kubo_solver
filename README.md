...
Depending on the kernel, the program performs symmetrization or antisymmetrization of the input data with respect to the half of Euclidean time.
...
```
Below we describe all possible parameters:
